...
~~~
esptool --chip esp32 merge-bin -o firmware-merged.bin --flash-mode dio --flash-freq 40m --flash-size 4MB 0x1000 wurmchat_with_ulawiTB_provision.ino.bootloader.bin  0x8000 wurmchat_with_ulawiTB_provision.ino.partitions.bin 0x10000 wurmchat_with_ulawiTB_provision.ino.bin
~~~
